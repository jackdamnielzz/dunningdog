...
import type { UseCaseData } from "@/components/marketing/usecase-data";
    ...
    <>
      ...
      <section className="px-4 py-12 sm:px-6">
        <div className="mx-auto max-w-3xl rounded-2xl border border-zinc-200 bg-zinc-50 p-6 sm:p-8">
          <blockquote className="text-lg font-medium leading-relaxed text-zinc-800">
      ...
      <section className="px-4 py-12 sm:px-6">
        <div className="mx-auto max-w-4xl rounded-2xl bg-accent-600 p-6 text-center text-white sm:p-10">
          ...
          <p className="mx-auto mt-3 max-w-xl text-accent-100">
            A business with $50k MRR typically loses $2,500-5,000/mo to failed payments.
